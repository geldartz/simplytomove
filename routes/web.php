...
Route::get('/auth/redirect/{provider}', [App\Http\Controllers\SocialController::class,'redirect'])->name('login.sso');
Route::get('/callback/{provider}', [App\Http\Controllers\SocialController::class,'callback'])->name('login.sso');


Route::get('{path}',[App\Http\Controllers\PageController::class, 'index'])->where('path','[-a-z0-9_\s]+');
