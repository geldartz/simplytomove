<template>
<section class="email-application">
                    ...
                    <div class="email-app-list-wrapper">
                        ...
                        <div class="email-user-list list-group">
                            ...
                            <li class="media mail-read">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-20.jpg" alt="avatar img holder">
                                </div>
                                </div>
                            ...
                            <li class="media mail-read">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-17.jpg"
                            ...
                            <li class="media">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-7.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-5.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media mail-read">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-3.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media mail-read">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-8.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-11.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media mail-read">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-10.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media mail-read">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-6.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-9.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <div class="pr-50">
                                <div class="avatar">
                                    <img src="/images/portrait/small/avatar-s-20.jpg"
                                    alt="Generic placeholder image">
                                </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="collapsible email-detail-head">
                                ...
                                <div id="headingCollapse5" class="card-header d-flex justify-content-between align-items-center"
                                    ...
                                    <div class="pr-1">
                                        ...
                                        <img src="/images/portrait/small/avatar-s-18.jpg" alt="avatar img holder"
                                            width="30" height="30">
                                        </div>
                                    </div>
                                ...
                                <div id="collapse5" role="tabpanel" aria-labelledby="headingCollapse5" class="collapse">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <img src="/images/icon/sketch.png" height="30" alt="sketch.png">
                                ...
                                <div id="headingCollapse6" class="card-header d-flex justify-content-between align-items-center"
                                    ...
                                    <div class="pr-1">
                                        <div class="avatar mr-75">
                                        <img src="/images/portrait/small/avatar-s-19.jpg" alt="avatar img holder"
                                            width="30" height="30">
                                        </div>
                                    </div>
                                    <div class="media-body mt-25">
...
import "/css/pages/app-email.css";
