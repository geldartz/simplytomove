    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
      ...
      <li class="nav-item">
        <a href="#">
          ...
          <span class="menu-title text-truncate">Post An Ad</span>
        </a>
        <ul class="menu-content">
          <li :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/post-an-ad'}">
            <a href="/panel/post-an-ad"  class="d-flex align-items-center">
              <i class="bx bx-right-arrow-alt"></i>
              <span class="menu-item text-truncate">New Ad</span>
            </a>
          </li>
          <li :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/my-ad'}">
            <a href="/panel/my-ad"  class="d-flex align-items-center">
              <i class="bx bx-right-arrow-alt"></i>
              <span class="menu-item text-truncate">My Ads</span>
            </a>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item" :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/emails'}">
        <a href="/panel/emails">
          <i class="menu-livicon" data-icon="envelope-pull"></i>
          <span class="menu-title text-truncate">Email</span>
        </a>
      </li>
      <li class="nav-item" :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/chat'}">
        <a href="/panel/chat">
      ...
      @can('isAdmin')
        <li class="nav-item">
          ...
          <ul class="menu-content">
            <li :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/post-an-ad'}">
              <a href="/panel/post-an-ad"  class="d-flex align-items-center">
                <i class="bx bx-right-arrow-alt"></i>
                <span class="menu-item text-truncate">Previews</span>
              </a>
            </li>
            <li :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/my-ad'}">
              <a href="/panel/my-ad"  class="d-flex align-items-center">
                <i class="bx bx-right-arrow-alt"></i>
                <span class="menu-item text-truncate">Charts</span>
              </a>
            </li>
          </ul>
        </li>
        <li class="nav-item">
          <a href="#">
            ...
            <span class="menu-title text-truncate">Site Maintenance</span>
          </a>
          <ul class="menu-content">
            <li :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/pricing'}">
              <a href="/panel/pricing"  class="d-flex align-items-center">
                <i class="bx bx-right-arrow-alt"></i>
                <span class="menu-item text-truncate">Pricing</span>
              </a>
            </li>
            <li :class="{'active': $route.fullPath ==='/' || $route.fullPath === '/panel/others'}">
              <a href="/panel/others"  class="d-flex align-items-center">
                <i class="bx bx-right-arrow-alt"></i>
                <span class="menu-item text-truncate">Others</span>
              </a>
            </li>
          </ul>
        </li>
